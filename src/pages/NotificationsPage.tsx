...
export const NotificationsPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div role="tablist" aria-label="Notification filters" className="flex bg-white/70 dark:bg-gray-900/70 backdrop-blur-xl rounded-xl p-1 gap-1 border border-white/60 dark:border-gray-800/60 shadow-sm overflow-x-auto">
