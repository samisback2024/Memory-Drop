        ...
        >
          <span
            className={[
              ...
              selected ? 'bg-purple-600 text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400',
            ].join(' ')}
          >
            <Icon size={15} aria-hidden="true" />
          </span>
          <span className="flex-1 min-w-0">
            <span className={`block text-sm font-medium ${selected ? 'text-purple-900 dark:text-purple-300' : 'text-gray-900 dark:text-gray-100'}`}>
              {meta.label}
            </span>
