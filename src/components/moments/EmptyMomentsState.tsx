...
const VARIANTS: Record<EmptyMomentsVariant, { icon: typeof PackageOpen; title: string; description: string }> = {
  active: { icon: PackageOpen, title: 'No moments yet', description: 'Add a photo, video, or a few words — it sticks around for 12, 24, or 48 hours, then it\'s just yours.' },
